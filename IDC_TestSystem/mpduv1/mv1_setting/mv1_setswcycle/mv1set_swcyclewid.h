#ifndef MV1SET_SWCYCLEWID_H
#define MV1SET_SWCYCLEWID_H

#include <QWidget>
#include "mv1set_swcycleitemwid.h"
namespace Ui {
class MV1Set_SwCycleWid;
}

class MV1Set_SwCycleWid : public QWidget
{
    Q_OBJECT

public:
    explicit MV1Set_SwCycleWid(QWidget *parent = 0);
    ~MV1Set_SwCycleWid();
...
private:
    Ui::MV1Set_SwCycleWid *ui;
    MV1Set_SnmpThread *mSnmp;
    MV1Set_RtuThread *mRtu;
    MV1Set_SwCycleItemWid *mWid[24];
    int mReg;
