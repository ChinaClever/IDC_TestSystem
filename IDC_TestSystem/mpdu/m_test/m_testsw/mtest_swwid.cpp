 ...
 *      Author: Lzy
 */
#include "mtest_swwid.h"
#include "ui_mtest_swwid.h"

MTest_SwWid::MTest_SwWid(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::MTest_SwWid)
{
    ui->setupUi(this);
    mReg = 1003;
    initwid();
...
MTest_SwWid::~MTest_SwWid()
{
    delete ui;
}


void MTest_SwWid::initwid()
{
    ...
    for(int i=0; i<24; ++i) {
        mWid[i] = new MTest_SwItemWid(wid[i]);
        mWid[i]->init(i);
    }

    mSnmp = new MTest_SnmpThread(this);
...
void MTest_SwWid::updateTextSlot(QString str)
{
    ui->textEdit->append(str);
}

void MTest_SwWid::on_checkBox_clicked(bool checked)
{
    for(int i=0; i<24; ++i) {
...
void MTest_SwWid::sendSnmp(int i)
{
    sSnmpSetCmd cmd;
...
void MTest_SwWid::on_pushButton_clicked()
{
...
void MTest_SwWid::on_openRadio_clicked(bool checked)
{
...
void MTest_SwWid::on_closeRadio_clicked(bool checked)
{
