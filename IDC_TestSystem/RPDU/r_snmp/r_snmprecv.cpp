...
void R_SnmpRecv::envData(const QByteArray &data)
{
    ...
    case 9: env->door[0] = data.toStdString()=="None."?0:1; break;
    case 10: env->door[1] = data.toStdString()=="None."?0:1; break;
    case 11: env->smoke[0] = data.toStdString()=="None."?0:1;break;
    case 12: env->water[0] = data.toStdString()=="None."?0:1; break;
